...
public class NearbyRestaurantsActivity extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // create MapView
        MapSingleton.mMapView =
                new MapView(this, "0qWWE8QtyZjzSnDl0NvQG5h9-_4c9ZTlirFOJJQ");

        // show NearbyRestaurantsListFragment
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        mNearbyRestaurantsListFragment =
                (NearbyRestaurantsListFragment) getSupportFragmentManager()
                        .findFragmentByTag(NearbyRestaurantsListFragment.TAG);
        if (mNearbyRestaurantsListFragment == null) {
            mNearbyRestaurantsListFragment =
                    new NearbyRestaurantsListFragment();
            ft.add(R.id.nearbyrest_frag_container,
                   mNearbyRestaurantsListFragment,
